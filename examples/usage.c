...
#define UPDATE_URL "https://www.arduprog.eu/fw.bin"         //adresa
...
/** WIFI CONNECTIVITY - NOT IMPORTANT ***/
...
/** Successful boot checking, and rollback handling
...
void app_main() {
    ...
    mark_image_valid(); //mark image as bootable, see README for more info
    //skus fetchnut fw
    char* url="https://arduprog.eu/fw.bin";
    ota_config_t ota_config ={
        .url=url,
        .CA_root=CA_pem,
        .timeout_ms=5000,
